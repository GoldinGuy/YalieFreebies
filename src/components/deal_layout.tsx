	...
	return (
		<section className="px-4 py-20 mx-auto max-w-7xl">
			<div className="flex flex-col items-start">
				<h1 className="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-black relative flex items-center self-start w-auto ">
			...
			<p className="mb-12 text-lg text-gray-500">
				Take advantage of your newfound collegiate status and save some moolah
				moolah!
			</p>
